...
const meetOrSliceTypes = exports.meetOrSliceTypes = {
  meet: 0,
  slice: 1,
  none: 2
};
const alignEnum = exports.alignEnum = ['xMinYMin', 'xMidYMin', 'xMaxYMin', 'xMinYMid', 'xMidYMid', 'xMaxYMid', 'xMinYMax', 'xMidYMax', 'xMaxYMax', 'none'].reduce((prev, name) => {
  prev[name] = name;
  return prev;
}, {});
